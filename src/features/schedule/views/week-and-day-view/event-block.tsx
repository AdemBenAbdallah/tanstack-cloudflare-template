...
import { ResizableEvent } from "@/features/schedule/dnd/resizable-event";
        ...
        <EventDetailsDialog event={event}>
          ...
          >
            ...
            {durationInMinutes > 25 && (
              <p>
                {formatTime(start, use24HourFormat, dateFnsLocale)} -{" "}
                {formatTime(end, use24HourFormat, dateFnsLocale)}
              </p>
            )}
          </button>
        </EventDetailsDialog>
