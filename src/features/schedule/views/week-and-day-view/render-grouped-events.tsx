...
import { getEventBlockStyle } from "@/features/schedule/helpers";
import type { IEvent } from "@/features/schedule/interfaces";
import { EventBlock } from "@/features/schedule/views/week-and-day-view/event-block";
...
export function RenderGroupedEvents({
  ...
  return groupedEvents.map((group, groupIndex) =>
    group.map((event) => {
      ...
      if (!hasOverlap)
        style = { ...style, width: "100%", insetInlineStart: "0%" };
